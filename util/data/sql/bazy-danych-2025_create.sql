...
-- Last modification date: 2025-01-08 01:42:12.052
...
-- Reference: PRODUCTS_DETAILS_ORDER (table: PRODUCTS_DETAILS)
ALTER TABLE PRODUCTS_DETAILS ADD CONSTRAINT PRODUCTS_DETAILS_ORDER
    FOREIGN KEY (order_id)
    REFERENCES ORDERS (order_id);

-- Reference: PRODUCTS_DETAILS_PRODUCT (table: PRODUCTS_DETAILS)
ALTER TABLE PRODUCTS_DETAILS ADD CONSTRAINT PRODUCTS_DETAILS_PRODUCT
    FOREIGN KEY (product_id)
    REFERENCES PRODUCTS (product_id);

-- Reference: PRODUCTS_DETAILS_STUDENT (table: PRODUCTS_DETAILS)
ALTER TABLE PRODUCTS_DETAILS ADD CONSTRAINT PRODUCTS_DETAILS_STUDENT
    FOREIGN KEY (student_id)
    REFERENCES STUDENTS (student_id);
